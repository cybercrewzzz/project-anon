  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <AuthButton label="Login" color="#9500FF" onPress={() => router.push('/start/authScreens/signIn' as any)} />
        <View style={styles.dividerText}>
          <AppText variant="headline" color="primary">
            OR
          </AppText>
        </View>
        <AuthButton label="Sign Up" color="#570096" onPress={() => router.push('/start/authScreens/signUp' as any)} />
      </View>
    </View>
  );
};
